...
private:
    ...
    * 3. VECTOR_ACCELEROMETER_Z - vectorZValues[3]
     ...
     */
    static constexpr uint16_t OBJECT_DICTIONARY_SIZE = 51;
    ...
    CO_OBJ_T objectDictionary[OBJECT_DICTIONARY_SIZE + 1] = {
        ...
        DATA_LINK_21XX(1, 1, CO_TUNSIGNED16, &vectorYValues[1]), // VECTOR_EULER_Y
        DATA_LINK_21XX(1, 2, CO_TUNSIGNED16, &vectorYValues[2]), // VECTOR_GYROSCOPE_Y
        DATA_LINK_21XX(1, 3, CO_TUNSIGNED16, &vectorYValues[3]), // VECTOR_LINEAR_ACCEL_Y
        DATA_LINK_21XX(1, 4, CO_TUNSIGNED16, &vectorYValues[4]), // VECTOR_ACCELEROMETER_Y

        DATA_LINK_START_KEY_21XX(2, 4),
        DATA_LINK_21XX(2, 1, CO_TUNSIGNED16, &vectorZValues[1]), // VECTOR_EULER_Z
        DATA_LINK_21XX(2, 2, CO_TUNSIGNED16, &vectorZValues[2]), // VECTOR_GYROSCOPE_Z
        DATA_LINK_21XX(2, 3, CO_TUNSIGNED16, &vectorZValues[3]), // VECTOR_LINEAR_ACCEL_Z
        DATA_LINK_21XX(2, 4, CO_TUNSIGNED16, &vectorZValues[4]), // VECTOR_ACCELEROMETER_Z
