...
int main() {
    ...
    auto &reg_select =
            IO::getGPIO<IO::Pin::PA_3>(IO::GPIO::Direction::OUTPUT);
    reg_select.writePin(IO::GPIO::State::LOW);

    auto &reset =
            IO::getGPIO<IO::Pin::PB_3>(IO::GPIO::Direction::OUTPUT);
    ...
    auto &cs =
            IO::getGPIO<IO::Pin::PB_12>(IO::GPIO::Direction::OUTPUT);
    cs.writePin(IO::GPIO::State::HIGH);

    auto &hudl_spi =
            IO::getSPI<IO::Pin::PB_13, IO::Pin::PB_15, IO::Pin::PC_11>(
                    devices, deviceCount);
